...
<t:_layout>
    <jsp:attribute name="body">
        <c:import url="${api}/products/${productID}" var="product" charEncoding="UTF-8"/>
                ...
                <div class="single-top-main">
                    <div class="col-md-5 single-top">
                        <div class="single-w3agile">
                            ...
                            <mt:st type="script" path="jquery.zoomtoo.js"/>
                            <script>
                                $(function () {
                    ...
                    <div class="col-md-7 single-top-left ">
                        <div class="single-right">
                            <h3><x:out select="$productDOM/prx/product/productName"/></h3>
                            <div class="pr-single">
                                <p class="reduced "><del>$<x:out select="$productDOM/prx/product/unitPrice"/></del>$<x:out select="$productDOM/prx/product/unitPrice"/></p>
                            </div>
                            <div class="block block-w3">
                                <div class="starbox small ghosting"> </div>
                            </div>
                            <p class="in-pa"> There are many variations of passages of Lorem Ipsum available, but the
        ...
        <c:set var="categoryID">
            <x:out select="$productDOM/prx/product/categoryID"/>
        </c:set>
